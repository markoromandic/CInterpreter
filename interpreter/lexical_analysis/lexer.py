...
RESERVED_KEYWORDS = {
    ...
    'unsigned_short': Token(UNSIGNED_SHORT, 'unsigned_short'),
    'unsigned_int': Token(UNSIGNED_INT, 'unsigned_int'),
    'unsigned_long': Token(UNSIGNED_LONG, 'unsigned_long'),
    'unsigned_char': Token(UNSIGNED_CHAR, 'unsigned_char'),
    'if': Token(IF, 'if'),
...
class Lexer(object):
    ...
    def _id(self):
        ...
        result = ''
        while self.current_char is not None and self.current_char.isalnum() or self.current_char is not None and self.current_char == '_':
            result += self.current_char
            self.advance()
