...
class ScopedSymbolTable(object):
    ...
    def _init_builtins(self):
        ...
        self.insert(BuiltinTypeSymbol('short'))
        self.insert(BuiltinTypeSymbol('int'))
        self.insert(BuiltinTypeSymbol('long'))
        self.insert(BuiltinTypeSymbol('float'))
        self.insert(BuiltinTypeSymbol('double'))
        self.insert(BuiltinTypeSymbol('unsigned'))
        self.insert(BuiltinTypeSymbol('unsigned_short'))
        self.insert(BuiltinTypeSymbol('unsigned_int'))
        self.insert(BuiltinTypeSymbol('unsigned_long'))
        self.insert(BuiltinTypeSymbol('unsigned_char'))
